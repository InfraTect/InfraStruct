...
class RegisterProviderTest {
    ...
    /** 픽스처: resourceScanner 자리에 넣을 아무 클래스(상한이 Class<?> 라 무엇이든 됨). */
    static class DummyScanner {}
    ...
    @RegisterProvider(
            providerId = "aws",
            resourceScanner = DummyScanner.class,
    ...
    void isRuntimeTypeWithAttributes() {
        ...
        assertThat(anno.resourceScanner()).isEqualTo(DummyScanner.class);
